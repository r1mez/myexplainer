...
# NOTES:
# EMD stands for earth move pair_distance, i.e. Wasserstein metric,
...
def emd(x, y, distance_scaling=1.0):
    ...
    :param x: 1D pmf
    :param y: 1D pmf
    :param distance_scaling: scaling factor for pair_distance matrix
    :return: EMD pair_distance
    """
    x = x.astype(float)
    y = y.astype(float)
...
def l2(x, y):
    """
    L2 pair_distance between two 1D pmf
    :param x: 1D pmf
    :param y: 1D pmf
    :return: L2 pair_distance
    """
...
def gaussian_emd(x, y, sigma=1.0, distance_scaling=1.0):
    """
    Gaussian kernel with squared pair_distance in exponential term replaced by EMD
    :param x: 1D pmf
    :param y: 1D pmf
