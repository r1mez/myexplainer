...
from GED.graphedx import GRAPHEDX_xor_on_edge
from GED.conf import get_conf, get_gmn_conf
import os
...
if __name__ == "__main__":
    ...
    dataset = Mutagenicity("../", mode="training")
    loader = DataLoader(dataset, batch_size=1, shuffle=False)
    # 初始化对称矩阵 (188个图 -> 188x188)
    ged_matrix = np.zeros((200, 200), dtype=float)
